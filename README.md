...
The draft is looking for real-world feedback. If you use CSV++ in a project, encounter an edge case, or have thoughts on the delimiter choices or syntax — open a [GitHub Discussion](../../discussions) or comment on the IETF datatracker.
